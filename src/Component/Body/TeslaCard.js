...
export default class TeslaCard extends React.Component {
  ...
  renderMyData(){
      fetch("https://newsapi.org/v2/everything?q=tesla&from=2022-12-19&sortBy=publishedAt&apiKey=987d9b29043b46279353bf1d19cde8b7")
