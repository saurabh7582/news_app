...
export default class AppleCard extends React.Component {
  ...
  renderMyData(){
      fetch("https://newsapi.org/v2/everything?q=apple&from=2023-01-18&to=2023-01-18&sortBy=popularity&apiKey=987d9b29043b46279353bf1d19cde8b7")
